...
sshpass -p  "$senha"  ssh root@192.168.0.10  "sudo rm -rf /media/docker_mount/testes_tcc/*/data sudo rm -rf /media/docker_mount/testes_tcc/*/logs"
...
sshpass -p  "$senha"  ssh root@192.168.0.20  "sudo rm -rf /media/docker_mount/testes_tcc/*/data sudo rm -rf /media/docker_mount/testes_tcc/*/logs"
