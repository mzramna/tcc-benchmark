...
sshpass -p  "$senha"  ssh root@192.168.0.10 "cd /home/mzramna/tcc-benchmark/containers_build/alpine_no_daemon && sudo docker-compose up --build --force-recreate -d --no-start"
...
sshpass -p  "$senha"  ssh root@192.168.0.20 "cd /home/mzramna/tcc-benchmark/containers_build/alpine_no_daemon && sudo docker-compose up --build --force-recreate -d --no-start"