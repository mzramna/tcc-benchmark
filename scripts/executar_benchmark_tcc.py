...
def executar_teste(host,user,password,database,port,tipo,sql_file_pattern,pre_execucao=1000,total_elementos=10000,total_threads=3):
    array=[]
    threads=[]
...
start_test("mariadb",paralel=True)
