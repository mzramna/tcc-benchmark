...
logstash_data={}
quantidade_elementos_geracao=10000
...
gerador.gerar_todos_dados_por_json_paralel(threads=0,select_country="pt_br",tipo=[1],quantidade_final=quantidade_elementos_geracao)
